...
namespace Avocado.Domain.Concrete
{
    public class AccountMembershipService : IMembershipService
    {
        ...
        public MembershipCreateStatus CreateUser(string email, string password)
        {
            ...
            _provider.CreateUser(username: email, password: password, email: email, passwordQuestion: null, passwordAnswer: null, isApproved: true, providerUserKey: null, status: out status);
            return status;
        }
